...
public class ObjetivosServiceImpl implements ObjetivosServiceUseCase {
	...
	/**
	 * Obtém uma lista de Objetivos Gerais.
	 * Recupera todos os objetos ODS do repositório, 
	 * converte cada um em um Objetivo Geral e retorna a lista.
	 *
	 * @return Lista de Objetivos Gerais.
	 */
	public List<ObjetivoGeral> obterObjetivos() {
	    return odsRepository.findAll().stream()
	                         .map(this::buildGeneralObjective)
	                         .collect(Collectors.toList());
	}

	/**
	 * Constrói um Objetivo Geral a partir de um objeto ODS.
	 * Cria um novo Objetivo Geral, define suas propriedades 
	 * com base nos dados do ODS e retorna o objetivo montado.
	 *
	...
	/**
	 * Constrói um Objetivo a partir de um objeto ODS.
	 * Cria e retorna um novo Objetivo usando os objetivos 
	 * brasileiro e global do ODS fornecido.
	 *
